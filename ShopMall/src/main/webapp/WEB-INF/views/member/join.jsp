	...
	<form id="join" action="join" method="post" name="formm">
		<fieldset>
			...
			<label>User ID</label> <input type="text" name="id" id="id"
				value="${id}" size="12"> <input type="hidden" name="reid"
				id="reid" value="${reid}"> <input type="button"
				value="중복 체크" class="dup" onclick="idcheck()"><br> <label>Password</label>
			<input type="password" name="pwd" id="pwd"><br> <label>Retype
				Password</label> <input type="password" name="pwdCheck" id="pwdCheck"><br>
		...
		<fieldset>
			...
			<br> <input type="text" name="addr2" size="25"
				style="margin-left: 140px"> <br> <label>Phone
